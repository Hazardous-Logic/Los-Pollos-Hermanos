    ...
    <>
      {orders && orders.length === 0 ? (
        <div className="container mx-auto my-10 rounded-xl py-5 md:w-2/3 lg:w-1/2 flex flex-col items-center bg-yellow-300">
          <div className=" p-7 shadow-xl bg-gray-200 text-gray-700 border border-gray-200 flex flex-col items-center rounded-xl">
            No Orders Yet!
          </div>
        </div>
      ) : (
        <div className="container mx-auto my-10 rounded-xl py-5 md:w-2/3 lg:w-1/2 flex flex-col items-center bg-yellow-300">
          <h2 className="text-4xl font-medium mt-10 text-black text-center mb-5">
            Order History
          </h2>
          <ul className="list-none w-1/2 p-0">
            {orders.map((order, index) => (
              <li
                key={index}
                className="mb-6 p-7 shadow-xl bg-gray-200 text-gray-700 border border-gray-200 flex flex-col items-center rounded-xl"
              >
